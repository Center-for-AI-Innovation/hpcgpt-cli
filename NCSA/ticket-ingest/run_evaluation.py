...
from src.stages import evaluate_summarization
...
if __name__ == "__main__":
    ...
    if args.output is None:
        ...
        args.output = f"results/{basename}_eval_results.jsonl"
    ...
    evaluate_summarization(system_prompt, args.data, args.output, args.model, args.slurm_config)